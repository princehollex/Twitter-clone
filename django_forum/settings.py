...
SECRET_KEY = 'django-insecure-xh#x2(56z^7sx=a!fq4$8159ayusu_zg7uq&o5)po)xx$)&gk*'
...
cloudinary.config( 
  cloud_name = "duoq06rnz", 
  api_key = "188155729653659", 
  api_secret = "RX9K20qO1hUVMBYhJX5LGCrQtZI" 
)
